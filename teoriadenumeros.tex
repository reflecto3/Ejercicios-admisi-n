...
\begin{solution}
    ...
    De esta forma, la B. y C. no son posibles, y como $12 > 6$ y piden la mayor cantidad de paquetes que puede hacer, entonces la opción correcta es la B.
    ...
    Este proceso, además, tiene la ventaja de que los números que quedan abajo (los que ya no tienen factores comunes) son justamente las cantidades de material que queda en cada paquete. Hay 12 paquetes con 3 lápices, 5 borradores y 7 reglas cada uno. \hfill $\square$
\end{solution}
...
\begin{solution}
    ...
    Esto es confirmado por lo que encontramos haciendo la tabla. \hfill $\square$
\end{solution}
...
\begin{solution}
    ...
    \begin{enumerate}[A.]
        ...
        \item $1400/20 = 70$ monedas cada una. Iveth por tanto tendría $70/7 = 10$ bolsas, y Marta, $70/5 = 7\cdot2 = 14$ bolsas. En este caso, Marta sí tiene 4 bolsas más que Iveth. Así la respuesta es la B.
    \end{enumerate}
    ...
    \begin{align*}
        ...
        x &= 10
    \end{align*}
    Así Iveth tiene 10 bolsitas, luego tenía $7\cdot10 = 70$ monedas de 20 gapes (y Marta tiene 14 bolsitas, $14\cdot5 = 70$ monedas) y por tanto en total $70\cdot20 = 1400$ gapes. \hfill $\square$
\end{solution}
...
\begin{solution}
    ...
    El peso de cada saco es 30 kg.  \hfill $\square$
\end{solution}
...
\begin{solution} \label{q:timbres}
    ...
    Podemos utilizar otro método, el tercer que usamos en el ejercicio \ref{q:fuentes}, para calcular el mínimo común múltiplo de $75, 80$ y $90$, los intervalos de tiempo en minutos en los que suena cada timbre:
...
\begin{solution}
    ...
    Convertimos 300 minutos en horas, $300/60 = 5$ horas. De esta forma la opción correcta es la C.
