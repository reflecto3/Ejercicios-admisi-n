...
\begin{solution}
    Sabemos convertir de años en P a días terrestres, y de años en Q a días terrestres. Nos piden combinar ambas para pasar de años en P a años en Q. Como cada año en P son 120 días terrestres, un habitante que tiene 7 años en P tiene por tanto $7\cdot 120$ d\'ias terrestres --- aún no lo calculamos, pues es más fácil dejarlo así y luego hacer todas las operaciones. Ahora bien, cada 140 días terrestres se obtiene un año de Q, por lo tanto, para pasar de días terrestres a años en Q hay que dividir entre 140. Así, el habitante tiene
    \[
    \frac{7\cdot 120}{140} = \frac{7\cdot 12}{14} = \frac{12}{2} = 6 \text{ años en Q.}
    \]
...
\begin{solution}
    Lo calculamos paso a paso. Carlos inicia con 810 gapes. Al primer sobrino le da una tercera parte, es decir $810/3 = (900-90)/3 = 300 - 30 = 270$ gapes, y le quedan $810-270 = 540$ gapes.
    
    Al segundo sobrino le ofrece $540/3 = (600-60)/3 = 200 - 20 = 180$ gapes, y le quedan $540-180 = 360$ gapes. 

    Por lo tanto, al tercer sobrino le dio $360/3= 120$ gapes. La opción correcta es la D.
\end{solution}
...
\begin{solution}
    El número 4 y el número 11 están diametralmente opuestos. Queremos saber entonces cómo se ve el carrusel y poder ver cuantos asientos tiene:
    \begin{center}
        \begin{tikzpicture}
            \foreach \x in {1,...,11}
                \node (\x) at (25*\x-25:1cm) {$\x$};
            \draw[<->, shorten <=3pt, shorten >=3pt] (4) -- (11);
        \end{tikzpicture}
    \end{center}
    Sabemos que del 4 al 11, excluyéndolos, hay de un lado 6 asientos en orden ascendente: 5, 6, 7, 8, 9, 10. Por lo tanto, del otro lado tienen que haber otros 6. El total de asientos es entonces 6 de un lado más 6 del otro más el 4 y el 11 son en total 14 asientos:

    \begin{center}
    \begin{tikzpicture}
    \foreach \x in {1,...,14}
        \node (\x) at ({360*(\x-1)/14}:1cm) {$\x$};
    \draw[green!60, thin] (360*3.5/14:1.2cm) arc[start angle=360*3.5/14, end angle=360*9.5/14, radius=1.2cm] -- (360*9.5/14:0.8cm) arc[start angle=360*9.5/14, end angle=360*3.5/14, radius=0.8cm] -- cycle;
    \draw[green!60, thin] (360*10.5/14:1.2cm) arc[start angle=360*10.5/14, end angle=360*16.5/14, radius=1.2cm] -- (360*16.5/14:0.8cm) arc[start angle=360*16.5/14, end angle=360*10.5/14, radius=0.8cm] -- cycle;
    \end{tikzpicture}
    \end{center}
...
\begin{questions}
    ...
    \begin{multicols}{3}
        \begin{parts}
            ...
            \part $\dfrac{16}{27}\div\dfrac{32}{15} =$
            \part $\dfrac{72}{28}\div\dfrac{7}{70} =$
            \part $\dfrac{16}{39}\div\dfrac{72}{13} =$
            \part $\dfrac{36}{76}\div\dfrac{48}{19} =$
            \part $\dfrac{15}{42}\div\dfrac{35}{49} =$
            \part $\dfrac{35}{81}\div\dfrac{28}{27} =$
            \part $\dfrac{92}{54}\div\dfrac{23}{9} =$
            \part $\dfrac{64}{88}\div\dfrac{56}{64} =$
            \part $\dfrac{12}{45}\div\dfrac{66}{50} =$
            \part $\dfrac{18}{37}\div\dfrac{12}{74} =$
            \part $\dfrac{24}{14}\div\dfrac{96}{49} =$
            \part $\dfrac{25}{16}\div\dfrac{80}{11} =$
            \part $\dfrac{26}{5}\div\dfrac{65}{40} =$
            \part $\dfrac{27}{17}\div\dfrac{63}{51} =$
            \part $\dfrac{33}{45}\div\dfrac{44}{55} =$
        \end{parts}
    \end{multicols}

    \question Resuelva y simplifique al máximo las siguientes sumas y restas de fracciones. Recuerde que para poder sumar o restar fracciones el denominador de ambas debe ser el mismo (i.e., deben ser fracciones homogéneas). En caso de que no sea así es necesario homogenizar, transformar las fracciones para que tengan el mismo denominador. Es posible que algunas den números negativos.

    \begin{multicols}{3}
        \begin{parts}
            \part $\dfrac{23}{5}+\dfrac{12}{5} =$
            \part $\dfrac{8}{9}+\dfrac{7}{9} =$
            \part $\dfrac{10}{6}+\dfrac{23}{6} =$
            \part $\dfrac{17}{12}+\dfrac{19}{12} =$
            \part $\dfrac{64}{7}+\dfrac{30}{7} =$
            \part $\dfrac{5}{7}+\dfrac{5}{2} =$
            \part $\dfrac{15}{8}+\dfrac{11}{4} =$
            \part $\dfrac{13}{4}+\dfrac{12}{3} =$
            \part $\dfrac{11}{9}+\dfrac{5}{6} =$
            \part $\dfrac{7}{3}+\dfrac{11}{2} =$
            \part $\dfrac{15}{9}+\dfrac{5}{2} =$
            \part $\dfrac{33}{6}+\dfrac{13}{5} =$
            \part $\dfrac{40}{4}+\dfrac{17}{5} =$
            \part $\dfrac{11}{5}+\dfrac{78}{10} =$
            \part $\dfrac{19}{4}+\dfrac{31}{8} =$

            \part $\dfrac{39}{4}-\dfrac{32}{4} =$
            \part $\dfrac{49}{6}-\dfrac{7}{6} =$
            \part $\dfrac{76}{15}-\dfrac{72}{15} =$
            \part $\dfrac{15}{7}-\dfrac{3}{2} =$
            \part $\dfrac{15}{11}-\dfrac{30}{22} =$
            \part $\dfrac{7}{3}-\dfrac{14}{9} =$
            \part $\dfrac{11}{6}-\dfrac{16}{9} =$
            \part $\dfrac{31}{8}-\dfrac{15}{4} =$
            \part $\dfrac{12}{9}-\dfrac{66}{5} =$
            \part $\dfrac{18}{2}-\dfrac{12}{11} =$
            \part $\dfrac{12}{7}-\dfrac{5}{21} =$
            \part $\dfrac{25}{7}-\dfrac{25}{9} =$
            \part $\dfrac{11}{8}-\dfrac{11}{9} =$
            \part $\dfrac{3}{4}-\dfrac{3}{12} =$
            \part $\dfrac{33}{44}-\dfrac{44}{55} =$
        \end{parts}
    \end{multicols}
    ...
    \[
        ...
        \begin{choices}
            \choice $\dfrac{23}{10}$
            \choice $\dfrac{1}{2}$
            \CorrectChoice $\dfrac{3}{10}$
            \choice $-\dfrac{3}{2}$
        \end{choices}
        
        \begin{solution}
            Vamos calculando las cosas paso a paso. Primero el numerador $\frac{a}{b}+\frac{b}{a}$, si $a=2$ y $b=3$:,
            \[
                \frac{2}{3}+\frac{3}{2} = \frac{2\cdot 2}{3\cdot2}+\frac{3\cdot3}{2\cdot3} = \frac{4+9}{6} = \frac{13}{6}.
                \]     
                A continuación el denominador
                \[
                    \frac{b}{a}+\frac{1}{ab} = \frac{3}{2}+\frac{1}{2\cdot3} = \frac{9}{6} + \frac{1}{6} = \frac{10}{6}.
                    \]
                    Dividiendo ambos
                    \[
                        \frac{\dfrac{13}{6}}{\dfrac{10}{6}} = \frac{\cancel{\dfrac{1}{6}}\cdot 13}{\cancel{\dfrac{1}{6}}\cdot 10} = \frac{13}{10}.
                        \]
                        Por último le restamos 1:
    \[
        \frac{13}{10}-1 = \frac{13-10}{10} = \frac{3}{10}.
        \]
...
\begin{solution}
    Veamos las opciones. Nos preguntan por una opción que sea imposible, por lo que basta ver que existe un caso hipotético en el que la opción es verdadera para afirmar que no sea imposible.
    \begin{enumerate}
        \item Que los cuatro recipientes queden con la misma cantidad de miel sí puede ocurrir, si cada uno termina con una cuarta parte.
        \item Si dos recipientes quedan con un tercio de la miel cada uno, el tercero con un cuarto y el cuarto con lo que queda. Vemos que este último queda con 
        \[1 -\frac{1}{3} - \frac{1}{3} -\frac{1}{4} = \frac{12}{12} -\frac{4}{12}-\frac{4}{12}-\frac{3}{12} = \frac{1}{12}\]
        Que es diferente al resto, por lo que esta opción es posible.
        \item En esta opción, C., la suma de las fracciones de miel es
        \[
        \frac{1}{6} + \frac{1}{6} + \frac{1}{2} + \frac{1}{3} = \frac{1}{6} + \frac{1}{6} + \frac{3}{6} + \frac{2}{6} = \frac{7}{6}
        \]
        siete sextos de la miel, lo que no puede ser, pues es más de lo que estaba en el recipiente original. Así, esta opción C. es imposible y por tanto es la correcta.
        \item No es difícil ver que en este caso
        \[\frac{1}{3} + \frac{1}{3} + \frac{1}{6} + \frac{1}{6} = 1\]
        como deberia ser. Luego este sí es posible.
    \end{enumerate}
    \hfill $\square$
\end{solution}
...
\begin{choices}
    ...
    \CorrectChoice compra el bolso y le sobra un doceavo de lo que llevaba.
    \choice puede comprar dos bolsos iguales.
\end{choices}

\begin{solution}
    Digamos que originalmente María tenía $X$ dinero. Ella primero gasta una tercera parte de lo que llevaba en unos tenis, $X/3$, por lo que le quedan dos terceras partes de $X$. Nos dicen que del dinero que le quedó, que es $2X/3$, gasta una cuarta parte en un abrigo. Esto sería
    \[\frac{1}{4}\cdot\frac{2}{3}X = \frac{1}{2\cdot3}X = \frac{X}{6}\]
    una sexta parte de lo que llevaba originalmente. Por lo tanto, al final del día le queda
    \[\frac{2}{3}X - \frac{1}{6}X = \frac{4}{6}X-\frac{1}{6}X = \frac{3}{6}X = \frac{X}{2}\]
    la mitad del dinero con el que inició. Como cinco doceavos es menor que un medio (pues un medio son seis doceavos), esto quiere decir que sí le alcanza, y que justamente le sobra
    \[
    \frac{1}{2}X-\frac{5}{12}X= \frac{6}{12}X - \frac{5}{12}X
    \]
    un doceavo de lo que llevaba. La respuesta correcta es la C. \hfill $\square$
\end{solution}
...
\begin{solution}
    Como en la anterior, si $X$ representa los ahorros de Lucía (la tía), entonces
    \begin{itemize}
        \item Alegandra recibe $X/4$ y quedan $3X/4$.
        \item Lucía recibe la tercera parte de $3X/4$, que es $X/4$ (la tercera parte de tres cuartos es un cuarto). Así, ya se fueron dos cuartos y queda la mitad del dinero, $X/2$.
        \item A Mario le dió la mitad de lo que queda. La mitad de un medio es un cuarto, $X/4$.
        \item Y a José lo que quedó, que es el último cuarto del dinero original, $X/4$.
    \end{itemize}
    Vemos por tanto que todos recibieron la misma cantidad de dinero. La respuesta correcta es la A. \hfill $\square$
\end{solution}
...
\begin{choices}
    ...
    \choice El último balde contiene más agua que cualquier otro balde.
    \choice El agua del tanque se distribuye en partes exactamente iguales entre los cuatro baldes.
\end{choices}

\begin{solution}
    Si $T$ representa la capacidad del tanque, el primer balde recibe $T/4$ de agua, y quedan $3T/4$. Los dos baldes medianos reciben (entre los dos) la mitad de esto, en partes iguales. Es decir, entre los dos reciben
    \[
    \frac{\dfrac{3}{4}T}{2} = \frac{3}{8}T\]
    Y como cada uno recibe lo mismo, cada uno recibe la mitad de esto que es $3T/16$. En el tanque quedaron los otros tres octavos, $3T/8$, y esto lo recibe el último balde. Veamos cuales son las opciones de respuesta:

    \begin{enumerate}[A.]
        \item La cantidad que recibe el último balde, $3T/8$ no es igual a la del primero, que recibió una cuarta parte. 
        \item Los baldes medianos recibieron cada uno $3T/16$, que es menor que lo que recibió el grande, $T/4 = 4T/16$.
        \item El último balde recibió $3T/8 = 6T/16$, que comparándolo con los otros es en efecto más que lo que recibió cualquier otro. Así, la respuesta correcta es la C.
    \end{enumerate}
    \hfill $\square$    
\end{solution}
...
\begin{choices}
    \choice $\dfrac{1}{5}$
    \CorrectChoice $\dfrac{4}{15}$
    \choice $\dfrac{7}{30}$
    \choice $\dfrac{1}{3}$
\end{choices}

\begin{solution}
    Si $P$ representa el pastel, Ana recibió $P/5$, y quedó $4P/5$ del pastel. Beatriz recibió la tercera parte de lo que quedó, es decir
    \[\dfrac{1}{3}\cdot\frac{4}{5}P = \frac{4}{15}P.\]
    Quedó entonces
    \[
    \left(1 - \frac{1}{5}-\frac{4}{15}\right) P = \frac{15-3-4}{15}P = \frac{8}{15}P
    \]
    De esto, Carmen recibió la mitad, que son $4P/15$, e Isabel se quedó con los otros $4P/15$. Así, la respuesta es la B. \hfill $\square$
\end{solution}
...
\begin{solution}
    Si $C$ representa todo el camino, en la primera hora Julián recorre $C/3$ y le queda por caminar $2C/3$. En la segunda hora recorre la mitad de esto, que son otros $C/3$, de forma que le quedan los últimos $C/3$. Pero en la tercera hora hizo solo la mitad de esto, que es $C/6$ (multiplicar el denominador por dos nos da la mitad), y quedan $C/6$. Por lo tanto, la respuesta correcta es la A. \hfill $\square$.
\end{solution}
...
\begin{solution}
    \begin{align*}
        &\left[\left(\frac{7}{12}+\frac{3}{16}\right)-\left(\frac{9}{32}-\frac{7}{40}\right)\right]\div\left(1-\frac{13}{16}\right) \\
        =&\left[\frac{7}{12}+\frac{6}{32}-\frac{9}{32}+\frac{7}{40}\right]\div\left(\frac{16}{16}-\frac{13}{16}\right) \\
        =& \left[\frac{7}{4\cdot3}-\frac{3}{32}+\frac{7}{8\cdot5}\right]\div\frac{3}{16} \\
        =& \left[\frac{7}{4\cdot3}-\frac{3}{32}+\frac{7}{8\cdot5}\right]\cdot\frac{16}{3} \\
        =& \frac{7\cdot 16}{4\cdot3\cdot 3}-\frac{3\cdot 16}{32\cdot 3}+\frac{7\cdot 16}{8\cdot5\cdot 3} \\
        =& \frac{7\cdot 4}{3\cdot 3}-\frac{1}{2}+\frac{7\cdot 2}{5\cdot 3} \\
        =& \frac{7\cdot 4\cdot 2\cdot 5}{3\cdot3\cdot2\cdot5} - \frac{1\cdot3\cdot3\cdot 5}{2\cdot3\cdot3\cdot5}+\frac{7\cdot2\cdot2\cdot3}{5\cdot3\cdot2\cdot3} \\
        =& \frac{280-45+84}{90} = \frac{319}{90}
    \end{align*}
